...
public class Door : MonoBehaviour
{
    ...
    public void Open(bool forward, GameObject entry)
    {
        if (_opened) { return; }
    ...
    //private void OnStartOpeningDoor(GameObject entry)
    //{
    //    if (entry.TryGetComponent(out PatrolingController pc))
    //    {
    //        pc.Stopped = true;
    //    }
    //}

    //private void OnEndOpeningDoor(GameObject entry)
    //{
    //    if(entry.TryGetComponent(out PatrolingController pc))
    //    {
    //        pc.Stopped = false;
